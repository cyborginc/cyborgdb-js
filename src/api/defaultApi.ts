...
export class DefaultApi {
    ...
    /**
 * Perform a batch query for multiple vectors.
 * @summary Batch Query Encrypted Index
 * @param batchQueryRequest
 */
public async batchQueryVectorsV1VectorsBatchQueryPost (
    ...
    // Verify required parameter 'batchQueryRequest' is not null or undefined
    if (batchQueryRequest === null || batchQueryRequest === undefined) {
        throw new Error('Required parameter batchQueryRequest was null or undefined when calling batchQueryVectorsV1VectorsBatchQueryPost.');
    }
    ...
    let localVarRequestOptions: localVarRequest.Options = {
        ...
        useQuerystring: this._useQuerystring,
        json: true,
        body: ObjectSerializer.serialize(batchQueryRequest, "BatchQueryRequest")
    };
