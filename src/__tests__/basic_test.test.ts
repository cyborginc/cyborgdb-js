import { Client, IndexIVFFlat, EncryptedIndex, QueryResponse } from '../index';
...
/**
 * Basic Integration Tests for CyborgDB.
 *
 * Covers IVF_FLAT only. (IVFPQ and IVFSQ are deprecated; their test
 * suites were removed when the service stopped supporting them.)
 *
