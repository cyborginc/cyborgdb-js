...
describe('getDemoApiKey', () => {
  ...
  test('should successfully generate demo API key', async () => {
    ...
    expect(['https://api.cyborgdb.co/v1/api-key/manage/create-demo-key', 'https://staging-api.cyborgdb.co/v1/api-key/manage/create-demo-key', 'https://dev-api.cyborgdb.co/v1/api-key/manage/create-demo-key']).toContain(callArgs[0]);
